  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="With Restaurant Booking Engine, reserve your table in a snap and let us handle the rest. Streamlining reservations and menu management, all in one place."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`With Restaurant Booking Engine, reserve your table in a snap and let us handle the rest. Streamlining reservations and menu management, all in one place.`}
            </Text>
            <Box
